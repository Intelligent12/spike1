...
const reply = (teks) => {
    Wizard.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: botname,mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, detectLinks: true,body: caption, thumbnail: thumbwiz,sourceUrl: ("github.com/Mohalicious")}}})
}
const replay = (teks) => {
    Wizard.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: botname,mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, body: caption, thumbnail: thumbwiz,sourceUrl: ("github.com/Mohalicious")}}})
}
...
body: caption,
mediaType: "VIDEO",
mediaUrl: `https://githb.com/Mohalicious/spike1`,
...
if (!isBotAdmins) return reply(`𝑺𝒑𝒊𝒌𝒆 𝘮𝘶𝘴𝘵 𝘣𝘦 𝘢𝘥𝘮𝘪𝘯 𝘧𝘪𝘳𝘴𝘵😚`)
